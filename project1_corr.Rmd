...
metrics.manyweak = metrics(models = models.manyweak,
                  p = 50,
                  n.strong = 8,
                  n.weak.ind = 6,
                  n.weak.cor = 6)
...
#### corr = 0.2
models.corr02 = lapply(1:N, function(i){
  model_fit(n.rows = 1000, 
            p = 50,
            n.strong = 8, 
            n.weak.ind = 4,
...
models.corr04 = lapply(1:N, function(i){
  model_fit(n.rows = 1000, 
            p = 50,
            n.strong = 8, 
            n.weak.ind = 4,
...
#### corr = 0.6
models.corr06 = lapply(1:N, function(i){
  model_fit(n.rows = 1000, 
            p = 50,
            n.strong = 8, 
            n.weak.ind = 4,
...
#### corr = 0.8
models.corr08 = lapply(1:N, function(i){
  model_fit(n.rows = 1000, 
            p = 50,
            n.strong = 8, 
            n.weak.ind = 4,
