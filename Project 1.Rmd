...
n.strong <- 10 # number of strong predictors
n.weak.cor <- 20 # number of weak and correlated preds
n.weak.ind <- 20 # number of weak and independent preds
...
cor.matrix[1, cor.ind] = cor.matrix[cor.ind, 1] = 0.4
...
b.strong.ind = sample(seq(1, p, 1)[-cor.ind], size = n.strong) # randomly designate strong predictors
...
b.true = rep(0, p)
b.true[b.strong.ind] = strong
b.true[-b.strong.ind] = weak
...
forward.varnumber = as.numeric(forward.varnumber)
