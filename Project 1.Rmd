...
## Power - probability of selecting a non-null 
## Bias - MSE of beta hats
...
truth.df = do.call(rbind, lapply(models, `[[`, 1)) # models[[1]][[1]]
forward.df = do.call(rbind, lapply(models, `[[`, 2))
lasso.df = do.call(rbind, lapply(models, `[[`, 3))

forward.prob = colMeans(forward.df)
lasso.prob = colMeans(lasso.df)

n.nonnull = sum(truth.df)
null.index = (n.nonnull + 1):(p - n.nonnull)
# Type I error
forward.t1 = mean(forward.prob[null.index])
